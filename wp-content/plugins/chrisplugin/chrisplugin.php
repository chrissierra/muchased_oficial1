...
/**
 * Plugin Name: Christopher Webpay Plus
...
include 'Transbank/vendor/autoload.php';
    ...
    class WC_Gateway_Transbank extends WC_Payment_Gateway
    {
        ...
        function check_ipn_response()
        {
            ...
            if(isset($_POST["ID"])){
                ...
                $this->check_ipn_request_is_valid($_POST["ID"], $_POST["TBK_TOKEN"]);
            }else{
            	wc_add_notice( __('Payment error hahahahah:', 'woothemes') . $error_message, 'error' );
...
//header('location:pico');
						   ...
						   // header('location:https://webpay3gint.transbank.cl/webpayserver/voucher.cgi');
						//	header('location:http://localhost/wordpress/mi-cuenta/view-order/'.$data.'?data='.$data);
